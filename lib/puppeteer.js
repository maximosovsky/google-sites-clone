...
async function extractWithPuppeteer(pageMap, outDir, options = {}) {
    const batchPause = options.cooldown || BATCH_PAUSE;
    ...
    console.log(`Extracting ${pageMap.pages.length} pages in ${batches.length} batches (cooldown: ${batchPause / 1000}s)`);
